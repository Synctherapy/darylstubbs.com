...
**Strict Warnings:** Never use bleach or abrasive brushes. Never submerge the USB-C port in water. Keep the pressure cap out of the dishwasher to prevent seal warping. [See our full [Echo Flask cleaning](/blog/echo-flask-cleaning) guide →](/blog/echo-flask-cleaning)
...
For advanced hardware diagnostics, check our [[Echo Flask troubleshooting](/blog/echo-flask-troubleshooting) guide →](/blog/echo-flask-troubleshooting).
...
*   → Echo Flask Warranty
*   [→ Best Hydrogen Water Bottles](/blog/best-hydrogen-water-bottles)
*   **Related Review:** Check out my comparative analysis on the [Hydrogen Water](/blog/hydrogen-water).
